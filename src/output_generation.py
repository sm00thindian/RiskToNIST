...
def generate_html(control_to_risk, nist_controls, cve_details, total_cves, output_file, core_controls_file='core_controls.csv'):
    ...
    html_content = """
                ...
                Risk-Based Control Assessment
                    ...
                    Control ID	Family	Control Description	Total Risk	Is Core Control	Associated CVEs
    """.format(
    ...
    for control_id, info in sorted_controls:
        ...
        html_content += f"""
                        	{control_id.upper()}	{family}	{description}	{total_risk:.1f}	{is_core}	
    ...
    for control_id, info in sorted_controls:
        ...
        for cve in sorted_cves:
            ...
            html_content += f"""
                            	{cve}	{cve_info['name']}	{cve_info['description']}	{cve_info['dueDate']}
            """
    ...
    html_content += """
                ...
                Generated by RiskToNIST | © {year} All rights reserved.
